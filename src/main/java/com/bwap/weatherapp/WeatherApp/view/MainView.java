...
public class MainView<cityName> extends UI {
    ...
    private void footer(){
        ...
        description.setValue("Weather App using vaaddin and java spring-boot ");
    ...
    private void updateUI() throws JSONException {
        ...
        //Updating Max Temp
        weatherMax.setValue("Max Temp: "+weatherService.returnMainObject().getInt("temp_max")+"C");
        //Updating Min Temp
        weatherMin.setValue("Min Temp: "+weatherService.returnMainObject().getInt("temp_min")+"C");
        //Updating Pressure
